...
--기본 문법
-- IN : 복수의 값 중에서 하나와 일치하는 경우
-- DALLAS에 위치한 부서의 부서번호 중
...
-- 부서 30번의 급여 중 하나라도 큰 값이 있다면 해당 사원보다 적은 급여를 가진 사원을 
-- 모두출력 
...
-- ALL
-- 부서 번호 30번의 모든 사원 보다 급여가 많은 사원의
-- 이름 출력
...
-- 30번 부서에서 가장 높은 급여보다 작게 급여를 받는 사원
SELECT ENAME, SAL FROM EMP
WHERE SAL < ALL (
    SELECT SAL FROM EMP WHERE DEPTNO = 30
);
