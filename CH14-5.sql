...
-- 삭제 테스트 
DELETE FROM dept_fk WHERE deptno = 10; -- 10번 부서 삭제, 자식 테이블도 같이 삭제됨
...
CREATE TABLE dept_fk3 ( -- 부모 테이블 : 1
  deptno  NUMBER PRIMARY KEY,
  dname   VARCHAR2(20),
  loc     VARCHAR2(20)
);
...
INSERT INTO dept_fk2 VALUES(10, '개발부', '서울');
INSERT INTO dept_fk2 VALUES(20, '인사부', '부산');
...
INSERT INTO emp_fk2 VALUES(102, '강감찬', NULL); --  NULL 입력해보기
SELECT * FROM emp_fk2;
